...
<head>
  ...
  <title>Orbit Insights - Space, Subcultures & The Future</title>
  <meta name="description" content="Exploring space technology, emerging subcultures, and the future of human expansion">
  <style>
    :root {
      --dark-bg: #0f0f0f;
      --card-bg: #1a1a2e;
